...
var SYSCALLS = {
  ...
  writeStatFs(buf, stats) {
    ...
    _asan_js_store(HEAP32, (((buf) + (60)) >> 2), stats.bsize);
    _asan_js_store(HEAP64, (((buf) + (8)) >> 3), BigInt(stats.blocks));
    _asan_js_store(HEAP64, (((buf) + (16)) >> 3), BigInt(stats.bfree));
    _asan_js_store(HEAP64, (((buf) + (24)) >> 3), BigInt(stats.bavail));
    _asan_js_store(HEAP64, (((buf) + (32)) >> 3), BigInt(stats.files));
    _asan_js_store(HEAP64, (((buf) + (40)) >> 3), BigInt(stats.ffree));
    _asan_js_store(HEAP32, (((buf) + (48)) >> 2), stats.fsid);
    _asan_js_store(HEAP32, (((buf) + (64)) >> 2), stats.flags);
    // ST_NOSUID
    _asan_js_store(HEAP32, (((buf) + (56)) >> 2), stats.namelen);
  },
...
var __emscripten_fs_load_embedded_files = ptr => {
  do {
    var name_addr = _asan_js_load(HEAPU32, ((ptr) >> 2));
    ptr += 4;
    var len = _asan_js_load(HEAPU32, ((ptr) >> 2));
    ptr += 4;
    var content = _asan_js_load(HEAPU32, ((ptr) >> 2));
    ptr += 4;
    var name = UTF8ToString(name_addr);
    FS.createPath("/", PATH.dirname(name), true, true);
    // canOwn this data in the filesystem, it is a slice of wasm memory that will never change
    FS.createDataFile(name, null, HEAP8.subarray(content, content + len), true, true, true);
  } while (_asan_js_load(HEAPU32, ((ptr) >> 2)));
};
...
var _emscripten_get_main_loop_timing = (mode, value) => {
  if (mode) _asan_js_store(HEAP32, ((mode) >> 2), MainLoop.timingMode);
  if (value) _asan_js_store(HEAP32, ((value) >> 2), MainLoop.timingValue);
};
...
var fillDeviceMotionEventData = (eventStruct, e, target) => {
  ...
  ag = ag || {};
  rr = rr || {};
  _asan_js_store(HEAPF64, ((eventStruct) >> 3), a["x"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (8)) >> 3), a["y"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (16)) >> 3), a["z"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (24)) >> 3), ag["x"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (32)) >> 3), ag["y"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (40)) >> 3), ag["z"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (48)) >> 3), rr["alpha"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (56)) >> 3), rr["beta"]);
  _asan_js_store(HEAPF64, (((eventStruct) + (64)) >> 3), rr["gamma"]);
};

var registerDeviceMotionEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
...
var fillOrientationChangeEventData = eventStruct => {
  ...
  _asan_js_store(HEAP32, ((eventStruct) >> 2), orientationIndex);
  _asan_js_store(HEAP32, (((eventStruct) + (4)) >> 2), orientationAngle);
};
...
/** @suppress {duplicate } */ var _emscripten_webgl_do_create_context = (target, attributes) => {
  ...
  var powerPreference = _asan_js_load(HEAP32, attr32 + (8 >> 2));
  var contextAttributes = {
    "alpha": !!_asan_js_load(HEAP8, attributes + 0),
    "depth": !!_asan_js_load(HEAP8, attributes + 1),
    "stencil": !!_asan_js_load(HEAP8, attributes + 2),
    "antialias": !!_asan_js_load(HEAP8, attributes + 3),
    "premultipliedAlpha": !!_asan_js_load(HEAP8, attributes + 4),
    "preserveDrawingBuffer": !!_asan_js_load(HEAP8, attributes + 5),
    "powerPreference": webglPowerPreferences[powerPreference],
    "failIfMajorPerformanceCaveat": !!_asan_js_load(HEAP8, attributes + 12),
    // The following are not predefined WebGL context attributes in the WebGL specification, so the property names can be minified by Closure.
    majorVersion: _asan_js_load(HEAP32, attr32 + (16 >> 2)),
    minorVersion: _asan_js_load(HEAP32, attr32 + (20 >> 2)),
    enableExtensionsByDefault: _asan_js_load(HEAP8, attributes + 24),
    explicitSwapControl: _asan_js_load(HEAP8, attributes + 25),
    proxyContextToMainThread: _asan_js_load(HEAP32, attr32 + (28 >> 2)),
    renderViaOffscreenBackBuffer: _asan_js_load(HEAP8, attributes + 32)
  };
...
var ASM_CONSTS = {
  ...
  154315511: () => Module["SDL3"].audioContext.sampleRate,
  154315562: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  154321067: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  154321126: ($0, $1, $2, $3, $4) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  154328337: () => Module["SDL3"]["mouse_x"],
  154328375: () => Module["SDL3"]["mouse_y"],
  154328413: $0 => Module["SDL3"]["mouse_buttons"][$0],
  154328461: $0 => {
    var data = $0;
    ...
    if (SDL3.makePointerEventCStruct === undefined) {
      SDL3.makePointerEventCStruct = function(left, top, event) {
        ...
        if (ptr != 0) {
          ...
          _asan_js_store(HEAP32, idx++, ptrtype);
          _asan_js_store(HEAP32, idx++, event.pointerId);
          _asan_js_store(HEAP32, idx++, (typeof (event.button) !== "undefined") ? event.button : -1);
          _asan_js_store(HEAP32, idx++, event.buttons);
          _asan_js_store(HEAP32, idx++, (event.type == "pointerdown") ? 1 : 0);
          _asan_js_store(HEAPF32, idx++, event.movementX);
          _asan_js_store(HEAPF32, idx++, event.movementY);
          _asan_js_store(HEAPF32, idx++, event.clientX - left);
          _asan_js_store(HEAPF32, idx++, event.clientY - top);
          if (ptrtype == 3) {
            _asan_js_store(HEAPF32, idx++, event.pressure);
            _asan_js_store(HEAPF32, idx++, event.tangentialPressure);
            _asan_js_store(HEAPF32, idx++, event.tiltX);
            _asan_js_store(HEAPF32, idx++, event.tiltY);
            _asan_js_store(HEAPF32, idx++, event.twist);
          }
        }
        return ptr;
      };
  ...
  154330705: () => document.body.clientWidth,
  154330743: () => document.body.clientHeight,
  154330782: () => window.innerWidth,
  154330812: () => window.innerHeight,
  154330843: () => window.outerWidth,
  154330873: () => window.outerHeight,
  154330904: () => window.pageXOffset,
  154330935: () => window.pageYOffset,
  154330966: ($0, $1) => {
    ...
    if (target) {
      ...
      var makeDropEventCStruct = function(event) {
        ...
        if (ptr != 0) {
          var idx = ptr >> 2;
          var rect = target.getBoundingClientRect();
          _asan_js_store(HEAP32, idx++, event.clientX - rect.left);
          _asan_js_store(HEAP32, idx++, event.clientY - rect.top);
        }
        return ptr;
      };
  ...
  154336747: () => window.innerWidth,
  154336777: () => window.innerHeight,
  154336808: $0 => {
  ...
  154337484: () => window.innerWidth,
  154337514: () => window.innerHeight,
  154337545: $0 => {
...
function assignWasmExports(wasmExports) {
  ...
  Module["_Emscripten_force_free"] = _Emscripten_force_free = createExportWrapper("Emscripten_force_free", 1);
  _fileno = createExportWrapper("fileno", 1);
  _fflush = createExportWrapper("fflush", 1);
  Module["_CallSDLEmscriptenMainFunction"] = _CallSDLEmscriptenMainFunction = createExportWrapper("CallSDLEmscriptenMainFunction", 3);
  Module["_SDLEmscriptenCameraPermissionOutcome"] = _SDLEmscriptenCameraPermissionOutcome = createExportWrapper("SDLEmscriptenCameraPermissionOutcome", 5);
  Module["_SDLEmscriptenThreadIterate"] = _SDLEmscriptenThreadIterate = createExportWrapper("SDLEmscriptenThreadIterate", 1);
  ...
  Module["_Emscripten_HandleLockKeysCheck"] = _Emscripten_HandleLockKeysCheck = createExportWrapper("Emscripten_HandleLockKeysCheck", 4);
...
function callMain(args = []) {
  ...
  var argv_ptr = argv;
  args.forEach(arg => {
    _asan_js_store(HEAPU32, ((argv_ptr) >> 2), stringToUTF8OnStack(arg));
    argv_ptr += 4;
  });
  _asan_js_store(HEAPU32, ((argv_ptr) >> 2), 0);
  try {
